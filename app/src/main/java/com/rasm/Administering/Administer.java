...
//        fakeImages.add(BitmapFactory.decodeResource(context.getResources(), R.drawable.image));
        ...
        users.add(new User("تقی","54565","taghi@gmail.com","09126745098", "taghiguli", 2,new ArrayList<User>(),R.drawable.ic_girl,new ArrayList<Integer>()));
        users.add(new User("نقی","10","naghi@gmail.com","09182345876", "naghiguli", 2,new ArrayList<User>(),R.drawable.ic_girl2,new ArrayList<Integer>()));
        ...
        users.add(new User("گری","777","sh3i123@yahoo.com","09128768876", "gareguri", 0,new ArrayList<User>(),R.drawable.ic_girl2,new ArrayList<Integer>()));
        users.add(new User("سری","678","sasdfd@yahoo.com","091887634987", "sariguli", 1,new ArrayList<User>(),R.drawable.ic_boy,new ArrayList<Integer>()));
